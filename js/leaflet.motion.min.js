      ...
      (L.Motion.Animate = {
        ...
        initialize: function (t, n, i, e) {
          L.Util.setOptions(this, n),
            (this.motionOptions = L.Util.extend(
              {},
              this.motionOptions,
              i || {}
            )),
            (this.markerOptions = L.Util.extend({}, e || {})),
        ...
        onAdd: function (t) {
          if (
            ...
            this.__marker._icon && this.__marker._icon.children.length)
          ) {
            var n = this.__marker._icon.children[0].getAttribute("motion-base");
            n &&
              (this.__marker._icon.children[0].style.transform =
                "rotate(" + n + "deg)");
          }
          return this.motionOptions.auto && this.motionStart(), this;
        },
        onRemove: function (t) {
          this.motionStop(),
        ...
        _motion: function (t) {
          ...
          if (
            ...
            L.Polyline.prototype.addLatLng.call(this, e.latLng),
        ...
        _drawMarker: function (t) {
          ...
          if (n) {
            ...
            else if (n._icon && n._icon.children.length) {
              var o = n._icon.children[0].getAttribute("motion-base");
              if (o) {
                var r = 0;
                o && !isNaN(+o) && (r = +o),
                  (n._icon.children[0].style.transform =
                    "rotate(-" +
                    Math.round(L.Motion.Utils.getAngle(i, t) + r) +
                    "deg)");
              }
            }
            n.setLatLng(t);
    ...
    L.Motion.Utils = {
      ...
      interpolateOnLine: function (t, n, i) {
        ...
        if (
          ...
          return {
            latLng: n[0] instanceof L.LatLng ? n[0] : L.latLng(n[0]),
            predecessor: -1,
          };
        if (1 == i)
          return {
        ...
        for (var r = 0, a = 0; a < n.length - 1; a++)
          r += n[a].distanceToNextPoint;
        for (var s = r * i, u = 0, h = 0, l = 0; h < s; l++) {
          var c = n[l],
            f = n[l + 1];
          (u = h), (h += c.distanceToNextPoint);
        }
        if (null == c && null == f) (c = n[0]), (f = n[1]), (l = 1);
        var m = h - u != 0 ? (s - u) / (h - u) : 0;
        return {
          latLng: this.interpolateOnLatLngSegment(c, f, m),
          predecessor: l - 1,
        };
      },
      ...
      distance: function (t) {
        for (var n = 0, i = 1; i < t.length; i++)
          n += map.distance(t[i], t[i - 1]);
        return n;
      },
    ...
    (L.Motion.Seq = L.Motion.Group.extend({
      ...
      __prepareStart: function () {
        ...
        this.getLayers().forEach(function (n) {
          n.off(L.Motion.Event.Ended, t.__clearActiveLayer__, t),
            n.on(L.Motion.Event.Ended, t.__clearActiveLayer__, t),
            n.off(L.Motion.Event.Started, t.__putActiveLayer__, t),
            n.on(L.Motion.Event.Started, t.__putActiveLayer__, t);
        });
      },
