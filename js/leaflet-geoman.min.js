!(function (t) {
    ...
    !(function (t) {
      ...
      function i(t, e, r) {
        null === e
          ...
          : (t.isSubject === e.isSubject
            ...
            e &&
              (t.prevInResult =
                !o(e, r) || e.isVertical() ? e.prevInResult : e)),
          (t.inResult = o(t, r));
      }
      function o(t, e) {
        switch (t.type) {
        ...
        return r[0] > n[0]
          ...
          : (function (t, e, r, n) {
              return t.left === e.left
                ? 0 === l(r, t.otherEvent.point, e.otherEvent.point)
                  ? !t.isSubject && e.isSubject
                    ? 1
                    : -1
      ...
      function c(t, e, r) {
        var n = new a(e, !1, t, t.isSubject),
          i = new a(e, !0, t.otherEvent, t.isSubject);
        return (
          s(t.point, t.otherEvent.point) &&
            console.warn("what is that, a collapsed segment?", t),
          (n.contourId = i.contourId = t.contourId),
          0 < h(i, t.otherEvent) && ((t.otherEvent.left = !0), (i.left = !1)),
      ...
      function f(t, e, r) {
        ...
        if (
          1 === i &&
          (s(t.point, e.point) || s(t.otherEvent.point, e.otherEvent.point))
        )
          return 0;
        if (2 === i && t.isSubject === e.isSubject) return 0;
        if (1 === i)
          return (
            s(t.point, n[0]) || s(t.otherEvent.point, n[0]) || c(t, n[0], r),
            s(e.point, n[0]) || s(e.otherEvent.point, n[0]) || c(e, n[0], r),
            1
          );
        var o = [],
          a = !1,
        ...
        return (
          s(t.point, e.point)
            ...
            ? o.push(e, t)
            : o.push(t, e),
          s(t.otherEvent.point, e.otherEvent.point)
            ? (l = !0)
            : 1 === h(t.otherEvent, e.otherEvent)
            ? o.push(e.otherEvent, t.otherEvent)
            : o.push(t.otherEvent, e.otherEvent),
          (a && l) || a
            ? ((e.type = 1),
              (t.type = e.inOut === t.inOut ? 2 : 3),
              a && !l && c(o[1].otherEvent, o[0].point, r),
              2)
            : (l
                ? c(o[0], o[1].point, r)
                : o[0] !== o[3].otherEvent
                ? (c(o[0], o[1].point, r), c(o[1], o[2].point, r))
                : (c(o[0], o[1].point, r), c(o[3].otherEvent, o[2].point, r)),
              3)
        );
      }
      function d(t, e) {
        if (t === e) return 0;
        if (
          0 !== l(t.point, t.otherEvent.point, e.point) ||
          0 !== l(t.point, t.otherEvent.point, e.otherEvent.point)
        )
          return s(t.point, e.point)
            ? t.isBelow(e.otherEvent.point)
              ? -1
              : 1
            : t.point[0] === e.point[0]
      ...
      function M(t, e, r, n, i, o) {
        var s, l, c, u, p, f;
        for (s = 0, l = t.length - 1; s < l; s++)
          if (
            ((c = t[s]),
            (u = t[s + 1]),
            (p = new a(c, !1, void 0, e)),
            (f = new a(u, !1, p, e)),
            (p.otherEvent = f),
            c[0] !== u[0] || c[1] !== u[1])
          ) {
            (p.contourId = f.contourId = r),
              o || ((p.isExteriorRing = !1), (f.isExteriorRing = !1)),
              0 < h(p, f) ? (f.left = !0) : (p.left = !0);
            var d = c[0],
              g = c[1];
            (i[0] = k(i[0], d)),
              (i[1] = k(i[1], g)),
          ...
          return (
            t.length * e.length == 0 &&
              (0 === r
                ...
                : 2 === r
                ? (n = t)
                : (1 !== r && 3 !== r) || (n = 0 === t.length ? e : t)),
            n
          );
        })(t, e, n);
        if (o) return o === w ? null : o;
        var a = [1 / 0, 1 / 0, -1 / 0, -1 / 0],
          ...
          l = (function (t, e, r, n, i) {
            ...
            for (s = 0, l = t.length; s < l; s++)
              for (c = 0, u = (o = t[s]).length; c < u; c++)
                (a = 0 === c) && L++, M(o[c], !0, L, p, r, a);
            for (s = 0, l = e.length; s < l; s++)
              for (c = 0, u = (o = e[s]).length; c < u; c++)
                (a = 0 === c),
                  2 === i && (a = !1),
                  a && L++,
                  M(o[c], !1, L, p, n, a);
          ...
          : (function (t, e) {
              ...
              for (r = 0, n = o.length; r < n; r++)
                if (!a[r]) {
                  var l = [[]];
                  o[r].isExteriorRing
                    ? 2 === e && !o[r].isSubject && 1 < s.length
                      ? s[s.length - 1].push(l[0])
                      : s.push(l)
                    : 2 !== e || o[r].isSubject || 0 !== s.length
                    ? 0 === s.length
                      ? s.push([[l]])
                      : s[s.length - 1].push(l[0])
                    : s.push(l);
                  ...
                  for (l[0].push(p); r <= u; )
                    (i = o[u]),
                      (a[u] = !0),
                      i.left
                        ? ((i.resultInOut = !1), (i.contourId = c))
                        : ((i.otherEvent.resultInOut = !0),
                          (i.otherEvent.contourId = c)),
                      (a[(u = i.pos)] = !0),
                      l[0].push(o[u].point),
                      (u = g(u, o, a, r));
                  (i = o[(u = -1 === u ? r : u)]),
              ...
              (function (t, e, n, o, a, s) {
                for (
                  var l, h, c, u = new r(d), p = [], g = Math.min(o[2], a[2]);
                  0 !== t.length;
                  ...
                  if (m.left) {
                    (h = l = u.insert(m)),
                      (l = l !== (c = u.minNode()) ? u.prev(l) : null),
                      (h = u.next(h));
                    var _ = l ? l.key : null;
                    if (
                      (i(m, _, s),
                      h && 2 === f(m, h.key, t) && (i(m, _, s), i(m, h.key, s)),
                      l && 2 === f(l.key, m, t))
                    ) {
                      var y = l;
                      i(_, (y = y !== c ? u.prev(y) : null) ? y.key : null, s),
                        i(m, _, s);
                    }
                  } else
                    (m = m.otherEvent),
      ...
      var x = { UNION: 1, DIFFERENCE: 2, INTERSECTION: 0, XOR: 3 };
    ...
    function i(t, e, r) {
      if (null !== t)
        for (
          ...
          l = (u =
            !!(c = g ? t.features[y].geometry : m ? t.geometry : t) &&
          ...
          for (var v = 0; v < l; v++) {
            ...
            if (null !== (s = u ? c.geometries[v] : c)) {
              ...
              var L = s.type;
              switch (
                ((p = !r || ("Polygon" !== L && "MultiPolygon" !== L) ? 0 : 1),
                L)
              ) {
                case null:
                  break;
                ...
                case "MultiPolygon":
                  for (n = 0; n < h.length; n++) {
                    for (o = k = 0; o < h[n].length; o++) {
                      for (a = 0; a < h[n][o].length - p; a++) {
                        if (!1 === e(h[n][o][a], f, y, b, k)) return !1;
                        f++;
                      }
                      k++;
                    }
  ...
  function (t) {
    t.exports = JSON.parse('{"a":"2.5.0"}');
  },
  function (t, e, r) {
    var n = r(60),
      i = r(117)(function (t, e, r) {
        n(t, e, r);
      });
    t.exports = i;
  },
    ...
    e.default = function t(e, r, n) {
      ...
      if ("MultiPolygon" === s.type) {
        for (var p = [], f = 0, d = s.coordinates; f < d.length; f++) {
          var g = d[f],
            m = t(o.getGeom(i.polygon(g)), l);
          if (m) {
            var _ = o.getGeom(m);
            if ("Polygon" === _.type) p.push(_.coordinates);
            else {
              if ("MultiPolygon" !== _.type)
                throw new Error("intersection is invalid");
              p = p.concat(_.coordinates);
            }
          }
        }
        return 0 === p.length
  ...
  function (t, e, r) {
    ...
    t.exports = function (t, e, r, y, v, b, k) {
      ...
      if (w) n(t, r, w);
        ...
        x && (k.set(M, C), v(C, M, y, b, k), k.delete(M)), n(t, r, C);
      }
    };
  },
  function (t, e, r) {
  ...
  function (t, e, r) {
    ...
    var M = y,
      w = {
        ...
        enableGlobalEditMode: function (t) {
          var e = b({ snappable: this._globalSnappingEnabled }, t);
          this.Toolbar.toggleButton("editMode", !0),
            M(this.map).forEach(function (t) {
              t.pm.enable(e);
            }),
      ...
      B = L.Class.extend({
        ...
        initialize: function (t) {
          (this.map = t),
            ...
            (this._globalRemovalMode = !1),
            (this.globalOptions = { snappable: !0 });
        },
        setLang: function () {
          var t =
              0 < arguments.length && void 0 !== arguments[0]
    ...
    function I(t) {
      ...
      return R()(m, e) || (e = "en"), D()(m[e], t);
    }
    var G = L.Control.extend({
      ...
      z = {
        ...
        _handleSnapping: function (t) {
          ...
          var n,
            ...
            a =
              o.layer instanceof L.Marker || o.layer instanceof L.CircleMarker;
          n = a ? o.latlng : this._checkPrioritiySnapping(o);
    ...
    (A.Line = A.extend({
      ...
      hasSelfIntersection: function () {
        return 0 < U()(this._layer.toGeoJSON(15)).features.length;
      },
      ...
      _createMarker: function (t, e) {
        ...
        return (
          ...
          e && this._hintMarker.setTooltipContent(I("tooltips.continueLine")),
          2 === this._layer.getLatLngs().length &&
            this._hintMarker.setTooltipContent(I("tooltips.finishLine")),
          r
        );
      },
    })),
      (A.Polygon = A.Line.extend({
        initialize: function (t) {
          (this._map = t),
            (this._shape = "Polygon"),
        ...
        _createMarker: function (t, e) {
          ...
          return (
            ...
            3 === this._layer.getLatLngs().length &&
              this._hintMarker.setTooltipContent(I("tooltips.finishPoly")),
            r
          );
        },
      })),
      (A.Rectangle = A.extend({
        initialize: function (t) {
          (this._map = t),
      ...
      (A.CircleMarker = A.Marker.extend({
        initialize: function (t) {
          (this._map = t),
    ...
    function X(t) {
      switch (t.type) {
        ...
        case "MultiPolygon":
          var e = [];
          if (
            (Object(W.flattenEach)(t, function (t) {
    ...
    A.Cut = A.Polygon.extend({
      ...
      _cut: function (t) {
        ...
        Object.keys(r)
          ...
          .filter(function (e) {
            try {
              return !!K()(t.toGeoJSON(15), e.toGeoJSON(15));
            } catch (t) {
              return (
          ...
          .forEach(function (r) {
            var n = (function (t, e) {
                var r = Object(Z.getGeom)(t),
                  n = Object(Z.getGeom)(e),
                  i = t.properties || {};
                if (((r = X(r)), (n = X(n)), !r)) return null;
                if (!n) return Object($.feature)(r, i);
                var o = q.diff(r.coordinates, n.coordinates);
                return 0 === o.length
                  ? null
                  : 1 === o.length
                  ? Object($.polygon)(o[0], i)
                  : Object($.multiPolygon)(o, i);
    ...
    var Y = {
        enableLayerDrag: function () {
          if ((this.disable(), this._layer instanceof L.Marker))
      ...
      (Q.Marker = Q.extend({
        ...
        enable: function () {
          ...
          L.Util.setOptions(this, t),
            ...
            this.enabled() || ((this._enabled = !0), this.applyOptions());
        },
        enabled: function () {
          return this._enabled;
        },
    ...
    var et = {
      ...
      createCache: function () {
        var t = [].concat(
          tt(this._markerGroup.getLayers()),
          tt(this.markerCache)
        );
      ...
      applyLimitFilters: function (t) {
        var e = t.latlng,
          ...
          n = tt(this._filterClosestMarkers(r));
        this.renderLimits(n);
      },
      _filterClosestMarkers: function (t) {
        var e = tt(this.markerCache),
    ...
    (Q.Line = Q.extend({
        ...
        if (this.hasSelfIntersection()) {
          ...
          t
            ...
            this._layer.fire("pm:intersect", {
              intersection: U()(this._layer.toGeoJSON(15)),
            });
      ...
      _createMiddleMarker: function (t, e) {
        var r = this;
        if (!t || !e) return !1;
        var n = _(this._map, t.getLatLng(), e.getLatLng()),
      ...
      _addMarker: function (t, e, r) {
        ...
        var n = t.getLatLng(),
          ...
          s = o.index,
          l = o.parentPath,
          h = 1 < a.length ? D()(i, l) : i,
          c = 1 < a.length ? D()(this._markers, l) : this._markers;
        h.splice(s + 1, 0, n),
          c.splice(s + 1, 0, t),
          this._layer.setLatLngs(i),
      ...
      _removeMarker: function (t) {
        ...
        if (o) {
          var l,
            h,
            c = 1 < o.length ? D()(n, s) : n,
            u = 1 < o.length ? D()(this._markers, s) : this._markers;
          if (
            (c.splice(a, 1),
      ...
      updatePolygonCoordsFromMarkerDrag: function (t) {
        var e = this._layer.getLatLngs(),
          ...
          o = n.index,
          a = n.parentPath;
        (1 < i.length ? D()(e, a) : e).splice(o, 1, r),
      ...
      _onMarkerDrag: function (t) {
        ...
        if (n) {
          ...
          var a = 1 < n.length ? D()(this._markers, o) : this._markers,
            s = (i + 1) % a.length,
      ...
      _onMarkerDragEnd: function (t) {
        ...
        this._layer.fire("pm:markerdragend", { markerEvent: t, indexPath: r }),
          this._fireEdit();
      },
