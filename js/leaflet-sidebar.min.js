(L.Control.Sidebar = L.Control.extend({
  ...
  initialize: function (t, s) {
    ...
    for (
      L.setOptions(this, s),
        ...
        L.Browser.touch && L.DomUtil.addClass(this._sidebar, "leaflet-touch"),
    ...
    for (
      ...
      if (
        ...
        this._panes.push(e);
        for (
          var o = e.querySelectorAll(".sidebar-close"), a = 0, l = o.length;
          a < l;
          a++
        )
  ...
  close: function () {
    ...
    return (
      L.DomUtil.hasClass(this._sidebar, "collapsed") ||
        (this.fire("closing"), L.DomUtil.addClass(this._sidebar, "collapsed")),
      this
    );
  },
  _onClick: function () {
