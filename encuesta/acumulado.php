...
$connect = new PDO("mysql:host=localhost;dbname=name;charset=utf8mb4", "db_user", "your-password");/* localhost es el servidor, "sigenbici" es el nombre de la base de datos, nombre de usuario, contraseña */
