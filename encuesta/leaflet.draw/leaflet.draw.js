...
/*       deleteLastVertex: function () {
      ...
      _onTouch: function (t) {
        L.Browser.touch &&
          (this._onMouseMove(t), this._onMouseDown(t), this._onMouseUp(t));
      },
    ...
    (L.Draw.Rectangle = L.Draw.SimpleShape.extend({
      ...
      _getTooltipText: function () {
        ...
        return (
          a &&
            ((t = this._shape.getLatLngs()),
            (e = L.GeometryUtil.geodesicArea(t)),
            (i = L.GeometryUtil.readableArea(e, this.options.metric))),
            ...
            this._tooltip.updateContent({
              ...
              subtext: o
                ? L.drawLocal.draw.handlers.circle.radius +
                  ": " +
                  L.GeometryUtil.readableDistance(e, a)
                : "",
            }));
      },
    })),
    ...
    (L.Edit.Poly = L.Handler.extend({
      ...
      addHooks: function () {
        var t = this._poly;
        t instanceof L.Polygon || (t.options.editing.fill = !1),
      ...
      _initMarkers: function () {
        ...
        for (t = 0, e = i - 1; i > t; e = t++)
          (0 !== t || (L.Polygon && this._poly instanceof L.Polygon)) &&
            ((s = this._markers[e]),
            (n = this._markers[t]),
            this._createMiddleMarker(s, n),
            this._updatePrevNext(s, n));
      },
      ...
      _createMiddleMarker: function (t, e) {
        ...
        n.setOpacity(0.6),
          (t._middleRight = e._middleLeft = n),
          (o = function () {
            var o = e._index;
            (n._index = o),
              n.off("click", i, this).on("click", this._onMarkerClick, this),
              (s.lat = n.getLatLng().lat),
              (s.lng = n.getLatLng().lng),
              this._poly.spliceLatLngs(o, 0, s),
              this._markers.splice(o, 0, n),
              n.setOpacity(1),
              this._updateIndexes(o, 1),
              e._index++,
              this._updatePrevNext(t, n),
              this._updatePrevNext(n, e),
              this._poly.fire("editstart");
          }),
          (a = function () {
            n.off("dragstart", o, this),
              n.off("dragend", a, this),
              n.off("touchmove", o, this),
              this._createMiddleMarker(t, n),
              this._createMiddleMarker(n, e);
          }),
          (i = function () {
    ...
    (L.Map.TouchExtend = L.Handler.extend({
      ...
      _touchEvent: function (t, e) {
        if (t.touches.length) {
          var i = this._map.mouseEventToContainerPoint(t.touches[0]),
            o = this._map.mouseEventToLayerPoint(t.touches[0]),
            a = this._map.layerPointToLatLng(o);
          this._map.fire(e, {
            latlng: a,
            layerPoint: o,
            containerPoint: i,
          ...
          for (var n = 0; o > n; n++)
            (e = t[n]),
              ...
              (a +=
                (i.lng - e.lng) *
                s *
                (2 + Math.sin(e.lat * s) + Math.sin(i.lat * s)));
      ...
      onAdd: function (t) {
        ...
        for (var s in this._toolbars)
          this._toolbars.hasOwnProperty(s) &&
            ...
            e &&
              (o ||
                (L.DomUtil.hasClass(e, a) ||
                  L.DomUtil.addClass(e.childNodes[0], a),
                (o = !0)),
              i.appendChild(e)));
        return i;
      },
    ...
    (L.Toolbar = L.Class.extend({
      ...
      _createActions: function (t) {
        ...
        for (var l = 0; r > l; l++)
          ("enabled" in n[l] && !n[l].enabled) ||
            ((e = L.DomUtil.create("li", "", s)),
            (a = this._createButton({
              title: n[l].title,
              text: n[l].text,
              container: e,
              callback: n[l].callback,
              context: n[l].context,
            })),
            this._actionButtons.push({ button: a, callback: n[l].callback }));
      },
    ...
    (L.Tooltip = L.Class.extend({
      ...
      updatePosition: function (t) {
        ...
        return (
          this._container &&
            ((i.style.visibility = "inherit"), L.DomUtil.setPosition(i, e)),
          this
        );
      },
      ...
      _enableLayerEdit: function (t) {
        ...
        this._backupLayer(i),
          this.options.selectedPathOptions &&
            ...
            e.maintainColor &&
              ((e.color = i.options.color),
              (e.fillColor = i.options.fillColor)),
            (i.options.original = L.extend({}, i.options)),
            (i.options.editing = e)),
          this.isMarker
            ? (i.dragging.enable(),
              i
