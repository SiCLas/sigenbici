...
$.getJSON("./visor/capas/ciclobanda-calzada.geojson", function (BandesCyclablesdata) {
  ...
  controlCapas.addOverlay(BandesCyclableslayer, '<span style="display: inline-block; height: 0.5em; width: 2em; border-top: dotted #0000ff 3px; vertical-align: middle;"></span><strong>&nbspCiclobandas en calzada</strong>');
});
...
$.getJSON("./visor/capas/carril-zona-30.geojson", function (MaxSpeed30data) {
  ...
  controlCapas.addOverlay(MaxSpeed30layer, '<span style="display: inline-block; height: 0.5em; width: 2em; border-top: solid #00bfff 4px; vertical-align: middle; opacity: 0.5"></span><strong>&nbspCarriles compartidos zona 30</strong>');
});
...
// mostrar escaleras con rampa o riel para bici
$.getJSON("./visor/capas/rampas.geojson", function (Rampasdata) {
  var RampasStyle = {
    "color": "#7C3D0C",
    "weight": 4,
    "opacity": 0.8,
  ...
  var Rampaslayer = L.geoJson(Rampasdata, {onEachFeature: recorreRazgos7, style: RampasStyle }).addTo(map);
  controlCapas.addOverlay(Rampaslayer, '<span style="display: inline-block; height: 0.5em; width: 2em; border-top: solid #7C3D0C 4px; vertical-align: middle; opacity: 0.5"></span><strong>&nbspEscaleras con rampa o riel para bici</strong>');
  //controlCapas.addOverlay(Rampaslayer, '<span style="display: inline-block; height: 1em; width: 2em;"><svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" version="1.1"><line x1="0%" x2="150%" y1="40%" y2="40%" stroke-linecap="butt" stroke-dasharray="2,1" stroke="#7a5b36" stroke-width="20%"/><line x1="0%" x2="150%" y1="70%" y2="70%" stroke-linecap="butt" stroke="#0000ce" stroke-width="10%"/></svg></span><strong>&nbspEscaleras con rampa o riel para bici</strong>');
});
...
$.getJSON("./visor/puntos/encicla-test-mapillary.geojson", function (Fontainedata2023) {
  ...
  var fontaineLayer2023 = L.geoJson(Fontainedata2023, {
    pointToLayer: function (feature, latlng) {
      ...
      marker.bindPopup("<strong>" + feature.properties.name + "</strong><br>" + (tipo_encicla(feature.properties.bicycle_rental)) + "<br><br>" + (info_descrip(feature.properties.description)) + (foto_mapi(feature.properties.mapillary)));
      return marker;
    }
  })
...
//Funcion para no mostrar tooltips con datos vacios
...
function foto_mapi(mapi){
 if (mapi == null){
    ...
    return "<br><iframe src='https://www.mapillary.com/embed?image_key=" + mapi + "&style=photo&sequence=false' height='auto' width='300px' frameborder='0'></iframe>";
 }
}
